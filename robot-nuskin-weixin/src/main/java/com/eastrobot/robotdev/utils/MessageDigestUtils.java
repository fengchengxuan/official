...
public class MessageDigestUtils {
	  private static MessageDigestUtils mdu;
	  private Key key;
	  ...
	  {
		  if(ValidationUtils.isEmpty(mdu))
			  mdu = new MessageDigestUtils();
		  return mdu;
	  }
	...
	public void setStrMi(String strMi) {
		this.strMi = strMi;
	}
	public void setStrMing(String strMing) {
	...
	public static void main(String[] args) throws UnsupportedEncodingException {
		String eid = "小苹果";
		String key = "123456";
		MessageDigestUtils md = MessageDigestUtils.getInstance();
		md.setKey(key);
		md.setEncString(eid);
		String mi = md.getStrMi();
		System.out.println(mi);
		//mi = URLEncoder.encode(mi,"utf-8");
		
		md.setKey(key);
		md.setDesString(mi);
		System.out.println(md.getStrMing());
	}
}
