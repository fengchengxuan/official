...
public class MD5 {
    ...
    public static void main(String[] args) throws Exception {
		...
		String str = Constants.NUSKIN+time;
		String s = MD5.GetMD5Code(str);
		String url = "http://xiaoitest.cn.nuskin.com:8000/dev/logout?token="+s+"&wid=oMdzOt8Bn8zZc4E-FetS4jeZ2mpw&time="+time;
